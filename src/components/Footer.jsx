...
function Footer() {
  ...
  return (
    <footer className="relative bg-footer overflow-hidden">
      {/* Left Rectangle Shape */}
      <div className="absolute left-20 top-0 h-full w-52 bg-footer -translate-x-8"></div>

      {/* Right Rectangle Shape */}
      <div className="absolute right-20 top-0 h-full w-52 bg-footer translate-x-8"></div>

      {/* Footer Content */}
      <div className="footer relative z-10 flex flex-col sm:flex-row justify-between items-center max-sm:items-start sm:items-start gap-6 py-10 px-6 sm:px-20">
        {/* Left Section */}
        <aside className="text-left max-w-md">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            Nam posuere accumsan porta. <br /> Integer id orci sed ante
